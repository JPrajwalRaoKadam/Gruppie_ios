...
//
    ...
    class AddHomeworkVC: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate, UIDocumentPickerDelegate {
        ...
        func uploadHomework() {
            ...
            URLSession.shared.dataTask(with: request) { data, response, error in
                ...
                if let raw = String(data: data, encoding: .utf8) {
                 ...
                 do {
                     let decoded = try JSONDecoder().decode(CreateAssignmentResponse.self, from: data)
    ...
    extension AddHomeworkVC: UITextFieldDelegate {
