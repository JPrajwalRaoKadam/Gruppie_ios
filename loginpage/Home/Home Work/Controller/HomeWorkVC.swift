...
class HomeWorkVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        Notes_videosTV.register(UINib(nibName: "classNameHWTableViewCell", bundle: nil), forCellReuseIdentifier: "classNameHWTableViewCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "classNameHWTableViewCell", for: indexPath) as? classNameHWTableViewCell else {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.navigateToSubjectStaffHWVC(classId: groupClass.id, groupClass: groupClass)
    }
...
extension HomeWorkVC {
    ...
    func navigateToSubjectStaffHWVC(classId: String, groupClass: GroupClass) {
        let storyboard = UIStoryboard(name: "HomeWork", bundle: nil)
        if let subjectNotesVC = storyboard.instantiateViewController(withIdentifier: "SubjectNotes_VideosHWVC") as? SubjectNotes_VideosHWVC {
