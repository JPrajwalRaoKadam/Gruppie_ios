...
class DetailViewController1: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
...
func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DispatchQueue.main.async {
            ...
            if let studentDetailVC = storyboard.instantiateViewController(withIdentifier: "StudentDaysViewController") as? StudentDaysViewController {
                studentDetailVC.studentName = selectedStudent.name 
                studentDetailVC.token = self.token
                studentDetailVC.groupIds = self.groupIds
                studentDetailVC.userId = userId
                studentDetailVC.teamId = self.teamId
                studentDetailVC.currentRole = self.currentRole
    ...
    private func navigateToAddStudentViewController() {
        ...
        let storyboard = UIStoryboard(name: "Student1", bundle: nil)
        if let addStudentVC = storyboard.instantiateViewController(withIdentifier: "AddStudentViewController1") as? AddStudentViewController1 {
