...
protocol AddRegularClassLabelCellDelegate1: AnyObject {
    func didTapIncrementButton(for classItem: ClassItem, at indexPath: IndexPath)
}

class AddRegularClassLabelCell1: UITableViewCell {
    @IBOutlet weak var className: UILabel!
    @IBOutlet weak var noOfSections: UILabel!
    @IBOutlet weak var incrementButton: UIButton!

    weak var delegate: AddRegularClassLabelCellDelegate1?
