...
class personalInfocell: UITableViewCell {
    ...
    private func textfeildDeesig(){
        firstNameTF.layer.cornerRadius = 10
        firstNameTF.layer.masksToBounds = true
        middleNameTF.layer.cornerRadius = 10
        middleNameTF.layer.masksToBounds = true
        lastNameTF.layer.cornerRadius = 10
        lastNameTF.layer.masksToBounds = true
        genderTF.layer.cornerRadius = 10
        genderTF.layer.masksToBounds = true
        dobTF.layer.cornerRadius = 10
        dobTF.layer.masksToBounds = true
        placeOfBirthTF.layer.cornerRadius = 10
        placeOfBirthTF.layer.masksToBounds = true
        bloodGroupTF.layer.cornerRadius = 10
        bloodGroupTF.layer.masksToBounds = true
        casteTF.layer.cornerRadius = 10
        casteTF.layer.masksToBounds = true
        nationalityTF.layer.cornerRadius = 10
        nationalityTF.layer.masksToBounds = true
        emailTF.layer.cornerRadius = 10
        emailTF.layer.masksToBounds = true
        maritalStatusTF.layer.cornerRadius = 10
        maritalStatusTF.layer.masksToBounds = true
        feeCategoryTF.layer.cornerRadius = 10
        feeCategoryTF.layer.masksToBounds = true
        aadhaarTF.layer.cornerRadius = 10
        aadhaarTF.layer.masksToBounds = true
        studentMobileTF.layer.cornerRadius = 10
        studentMobileTF.layer.masksToBounds = true
        religionTF.layer.cornerRadius = 10
        religionTF.layer.masksToBounds = true
    ...
    private func setupTextFields() {
        ...
        let otherFields = [middleNameTF, lastNameTF, placeOfBirthTF,
...
extension personalInfocell: UIPickerViewDelegate, UIPickerViewDataSource {
